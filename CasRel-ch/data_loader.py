...
class data_generator:
    ...
    def __iter__(self):
        while True:
            ...
            tokens_batch, segments_batch, sub_heads_batch, \
            sub_tails_batch, sub_head_batch, sub_tail_batch, \
            ...
            for idx in idxs:
                ...
                for triple in line['triple_list']:
                    # print("triple[0]: ", self.tokenizer.tokenize(triple[0]))
                    # print("triple[2]: ", self.tokenizer.tokenize(triple[2]))
                ...
                if s2ro_map:
                    ...
                    obj_heads, obj_tails = np.zeros((text_len, self.num_rels)), \
                                           np.zeros((text_len, self.num_rels))
